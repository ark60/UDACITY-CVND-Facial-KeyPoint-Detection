...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        # NOTE : I have tried different model structure (More depth).Also I used input size = 224*224. Their training time 
        
        # too long to complete training process with my hardware (I used CPU). I decided to reduce input size = 96*96 and use 
        
        # some modification of LeNet structure. I have taken good accuracy    
